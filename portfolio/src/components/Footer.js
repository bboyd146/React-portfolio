                    ...
                    <div class="mt-28 pb-20 border-t-2 border-gray-300 flex flex-col items-center">
                        <div class="sm:w-2/3 text-center py-6">
                            <div class="flex flex-wrap justify-center gap-6 pt-2">
                                ...
                                <a href="http://www.github.com/bboyd146">
                                    <button
                                ...
                                <a href="mailto:braddboyd5@gmail.com">
                                    <button
                                        class="bg-indigo-700 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded"
                                    >
